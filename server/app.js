                ...
                if (err) {
                    ...
                    await pool.query("INSERT INTO users (username, password) VALUES ($1, $2) RETURNING *", [username, hash], (error, result) => {
                        if (error && error.code === "23505") {
                            ...
                            res.cookie("jwt", token, { maxAge: 43200000, httpOnly: true, secure: true, domain: "restapi.ca", sameSite: "lax" })
...
app.get("/api/logout", (req, res) => {
    res.cookie("jwt", "", { maxAge: 0, httpOnly: true, secure: true, domain: "restapi.ca", sameSite: "lax" })
