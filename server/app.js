...
app.use(cors({ credentials: true, origin: true, methods: "GET,HEAD,PUT,PATCH,POST,DELETE", preflightContinue: true }))
                ...
                if (err) {
                    ...
                    await pool.query("INSERT INTO users (username, password) VALUES ($1, $2) RETURNING *", [username, hash], (error, result) => {
                        if (error && error.code === "23505") {
                            ...
                            res.cookie("jwt", token, { maxAge: 43200000, httpOnly: false})
