                ...
                if (err) {
                    ...
                    await pool.query("INSERT INTO users (username, password) VALUES ($1, $2) RETURNING *", [username, hash], (error, result) => {
                        if (error && error.code === "23505") {
                            ...
                            res.cookie("jwt", token, { maxAge: 43200000, secure: true, domain: "chainlink.restapi.ca", sameSite: "none" })
...
app.get("/api/logout", (req, res) => {
    res.cookie("jwt", "", { maxAge: -1, secure: true, domain: "chainlink.restapi.ca", sameSite: "none" })
